...
import { GeminiContentGenerator } from '../core/geminiContentGenerator.js';
...
export class EmbeddingIndex {
  ...
  private dimension: number = 768; // gemini-embedding-001 dimension
  private contentGenerator: GeminiContentGenerator | null = null;
  ...
  private async getContentGenerator(): Promise<GeminiContentGenerator> {

...
## PK Code Development Guide

This document serves as the comprehensive development guide for PK Code contributors. It includes architecture details, coding standards, and implementation guidelines.

For AI agents working on this codebase, please also refer to `AGENTS.md` for agent-specific guidance.
